...
import { Github, Gitlab, ChevronLeft, Star, GitBranch, Clock, Search, Filter, X } from "lucide-react";
import Sidebar from "@/app/components/sidebar";
const repositories = [
  { name: "Nextjs_boilerplate", stars: 45, language: "TypeScript", updated: "2 days ago", private: false },
  { name: "vijaypvk", stars: 12, language: "JavaScript", updated: "1 week ago", private: true },
  { name: "Devops_pratice-", stars: 8, language: "Shell", updated: "3 days ago", private: false },
  { name: "vijay_portfolio", stars: 23, language: "React", updated: "5 days ago", private: false },
  { name: "my-pics", stars: 3, language: "HTML", updated: "2 weeks ago", private: true },
  { name: "devops-assignment-aws-ecs", stars: 67, language: "Python", updated: "1 day ago", private: false },
  { name: "proxmox_mcp_agent", stars: 34, language: "Go", updated: "4 days ago", private: false },
  { name: "Monaco-code-editor-in-electron", stars: 156, language: "JavaScript", updated: "6 days ago", private: false },
  { name: "BASH", stars: 89, language: "Shell", updated: "1 week ago", private: false },
  { name: "devops_notes", stars: 234, language: "Markdown", updated: "3 days ago", private: false },
];
...
export default function DeployPage() {
  ...
  const [githubAccount, setGithubAccount] = useState("vijaypvk");
  ...
  return (
    <div>
      <Sidebar/>
    <main className="min-h-screen bg-black text-white p-8 ml-52">
      {/* Back link */}
      ...
      {showBanner && (
        <div className="relative bg-gradient-to-r from-blue-900/90 to-blue-800/90 backdrop-blur-sm text-sm text-white p-4 rounded-xl mb-8 shadow-lg border border-blue-700/50">
          ...
          <div className="relative">
            ...
            See how Workers compares to Pages in our{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          {filteredRepos.map((repo, idx) => (
            <div
              ...
              className={`bg-[#27272a] p-4 rounded-xl border transition-all cursor-pointer hover:scale-105 hover:shadow-lg group ${
